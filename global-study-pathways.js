...
(function(){
  ...
  const moneyIds=['duration','tuition','housing','living','health','travel','otherAnnual','setup','scholarship','governmentSupport','familyContribution','approvedLoan','partTime'];
  const textIds=['stage','field','destination','annualBudget'];
  const allPersistIds=[...moneyIds,...textIds];
